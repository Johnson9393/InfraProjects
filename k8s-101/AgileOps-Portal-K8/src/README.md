# Project AgileOps Portal

A Flask bootcamp app that combines a **student portal**, **sprint retrospectives**, **Jira-style ticketing**, and **team management** — containerized with AWS EKS.

**Location:** `k8s-101/AgileOps-Protal-K8/src`
...
```bash
cd k8s-101/AgileOps-Protal-K8/src
